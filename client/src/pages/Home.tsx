        ...
        <div className="container relative z-10 pt-24 pb-20">
          <div className="max-w-3xl">
            ...
            >
              ...
              estimates. Use our instant estimator or book directly. Results you
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              >
                Upload photos and get an instant estimate. Our system analyzes
                your surfaces and provides accurate pricing in seconds.
              </p>
            </div>
            ...
            >
              ...
              >
                <li>
                  <strong>1. Upload Photos:</strong> Take clear photos of the
                  area you want cleaned
                </li>
                <li>
                  <strong>2. AI Analysis:</strong> Our system analyzes surface
                  type, size, and condition
                </li>
                <li>
                  <strong>3. Instant Quote:</strong> Get an accurate estimate
                  immediately
                </li>
                <li>
                  <strong>4. Book or Contact:</strong> Schedule your service or
            ...
            <div className="text-center mt-8">
              ...
              >
                ...
                <a
                  href="tel:3144670332"
                  style={{ color: "oklch(0.72 0.12 75)", fontWeight: "bold" }}
                >
                  (314) 467-0332
                </a>
              </p>
