      ...
      process={[
        {
          ...
          description:
            "We inspect the deck material, condition, and level of buildup to determine the safest and most effective cleaning approach.",
        },
        {
          step: "02",
          title: "Soft Wash or Pressure Wash",
          description:
            "Depending on the material, we either soft wash with a biodegradable cleaning solution or use controlled pressure washing to lift and remove all organic growth and grime.",
        },
        {
          step: "03",
          title: "Rinse & Walk-Through",
          description:
            "We thoroughly rinse the deck and surrounding area, then walk the job with you to confirm you're happy with the results.",
        },
      ]}
      faqs={[
        {
          ...
          answer:
            "Yes, when done correctly. We use lower pressure settings and appropriate nozzles for composite materials like Trex to avoid surface damage. We never use high-pressure wands directly on composite boards.",
        },
        {
          question: "Will cleaning my deck prepare it for staining?",
          answer:
            "Absolutely — a clean deck is essential before staining or sealing. Our cleaning removes all the grime, mildew, and gray weathering that would prevent stain from penetrating evenly.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Once a year is recommended for most decks in Missouri, especially those with tree coverage. Regular cleaning extends the life of the wood and prevents permanent staining.",
        },
      ]}
      relatedServices={[
