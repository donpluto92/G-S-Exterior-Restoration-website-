...
const translations = {
  en: {
    ...
    aboutUs: 'About Us',
    honestWork: 'Honest Work. Dependable Service.',
    ...
    getYourInstantEstimate: 'Get Your Instant Estimate',
    uploadPhotosEstimate: 'Upload photos and get an instant estimate. Our system analyzes your surfaces and provides accurate pricing in seconds.',
    disclaimer: 'This is an approximate estimate only. Final pricing may vary based on on-site assessment.',
    howItWorks: 'How It Works',
    uploadPhotos: 'Upload Photos: Take clear photos of the area you want cleaned',
    aiAnalysis: 'AI Analysis: Our system analyzes surface type, size, and condition',
  ...
  es: {
    ...
    honestWork: 'Trabajo Honesto. Servicio Confiable.',
    ...
    getYourInstantEstimate: 'Obtenga Su Estimación Instantánea',
    uploadPhotosEstimate: 'Cargue fotos y obtenga una estimación instantánea. Nuestro sistema analiza sus superficies y proporciona precios precisos en segundos.',
    disclaimer: 'Esta es solo una estimación aproximada. El precio final puede variar según la evaluación en el sitio.',
    howItWorks: 'Cómo Funciona',
    uploadPhotos: 'Cargar Fotos: Tome fotos claras del área que desea limpiar',
    aiAnalysis: 'Análisis de IA: Nuestro sistema analiza el tipo de superficie, tamaño y condición',
